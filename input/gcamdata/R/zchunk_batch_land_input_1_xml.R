...
#' module_aglu_batch_land_input_1_xml
#'
...
module_aglu_batch_land_input_1_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L221.LN1_SoilTimeScale_Peat <- get_data(all_data, "L221.LN1_SoilTimeScale_Peat")
    ...
    create_xml("land_input_1.xml") %>%
      ...
      add_xml_data(L221.LN1_SoilTimeScale_Peat, "LN1_SoilTimeScale_Peat") %>%
      ...
      add_precursors("L221.LN0_Logit", "L221.LN0_Land", "L221.LN0_SoilTimeScale", "L221.LN1_ValueLogit", "L221.LN1_HistUnmgdAllocation", "L221.LN1_UnmgdAllocation", "L221.LN1_UnmgdCarbon", "L221.LN1_SoilTimeScale_Peat") ->
      land_input_1.xml
