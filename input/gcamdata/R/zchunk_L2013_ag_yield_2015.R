...
module_aglu_ag_yield_2015 <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    # Create a similar table to allow expansion to peat soils
    L2013.AgTechs_Peat <- subset(L2013.AgTechs, endsWith(AgProductionTechnology, paste0(aglu.PEAT_DELIMITER, "Peat"))) %>%
    ...
    L2013.AgProdChange_2015 <- L2013.WeightedYieldGrowth %>%
      ...
      append_peat_technologies(L2013.AgTechs_Peat) %>%
