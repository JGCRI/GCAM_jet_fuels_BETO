...
module_emissions_batch_all_protected_unmgd_emissions_xml <- function(command, ...) {
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    L212.PASTUREEmissionsFactors_Peat_prot <- get_data(all_data, "L212.PASTUREEmissionsFactors_Peat_prot")
    L212.PASTUREEmissionsFactors_Peat_noprot <- get_data(all_data, "L212.PASTUREEmissionsFactors_Peat_noprot")
    ...
    create_xml("all_protected_unmgd_emissions.xml") %>%
      ...
      add_xml_data(L212.PASTUREEmissionsFactors_Peat_prot, "InputEmFactUnmgd") %>%
      add_xml_data(L212.PASTUREEmissionsFactors_Peat_noprot, "InputEmFactUnmgd")->
