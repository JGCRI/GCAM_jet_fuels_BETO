...
module_aglu_LA100.FAO_downscale_ctry <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "aglu/AGLU_ctry",
             ...
             FILE = "aglu/FAO/FAO_ag_Prod2_t_SUA",
    ...
    FAO_ag_Prod2_t_SUA <- get_data(all_data, "aglu/FAO/FAO_ag_Prod2_t_SUA")
    ...
    list("FAO_ag_Exp_t_SUA" = FAO_ag_Exp_t_SUA,
         ...
         "FAO_ag_Prod2_t_SUA" = FAO_ag_Prod2_t_SUA,
    ...
    L100.FAOlist[["L100.FAO_ag_Imp_t"]] %>%
      ...
      L100.FAO_ag_Imp_t
    L100.FAOlist[["L100.FAO_ag_Prod2_t"]] %>%
      add_title("FAO animal imports by country, item, year") %>%
      add_units("t") %>%
      add_precursors("aglu/FAO/FAO_ag_Prod2_t_SUA", "aglu/AGLU_ctry") ->
      L100.FAO_ag_Prod2_t
