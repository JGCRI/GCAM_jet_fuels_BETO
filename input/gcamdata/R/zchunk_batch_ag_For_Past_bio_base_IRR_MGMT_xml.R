...
module_aglu_batch_ag_For_Past_bio_base_IRR_MGMT_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2252.AgProduction_ag_irr_mgmt <- get_data(all_data, "L2252.AgProduction_ag_irr_mgmt")
    ...
    create_xml("ag_For_Past_bio_base_IRR_MGMT.xml") %>%
      ...
      add_xml_data(L2252.AgProduction_ag_irr_mgmt, "AgProduction") %>%
      ...
      add_precursors("L2012.AgSupplySubsector", "L2252.AgProduction_ag_irr_mgmt",
