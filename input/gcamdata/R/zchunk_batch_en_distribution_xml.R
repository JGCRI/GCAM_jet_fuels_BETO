...
module_energy_batch_en_distribution_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L226.StubTechInterp_en <- get_data(all_data, "L226.StubTechInterp_en")
    ...
    L226.fixOut_waste_HEFA <- get_data(all_data, "L226.fixOut_waste_HEFA")
    ...
    en_distribution.xml %>%
      ...
      add_xml_data(L226.StubTechInterp_en, "StubTechInterp") %>%
      ...
      add_xml_data(L226.fixOut_waste_HEFA, "StubTechFixOut_otherBiod") %>%
