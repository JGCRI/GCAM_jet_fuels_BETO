...
module_energy_L202.Ccoef <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    ag_en <- c("regional corn for ethanol", "regional sugar for ethanol", "regional biomassOil oilcrop",
               "regional biomassOil rapeseed","regional biomassOil palmfruit","regional biomassOil soybean")
    L202.CarbonCoef %>%
