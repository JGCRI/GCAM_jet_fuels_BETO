...
module_energy_L2231.wind_update <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2231.SmthRenewRsrcCurves_onshore_wind %>%
      ...
      add_precursors( "common/iso_GCAM_regID", "common/GCAM_region_names", "energy/mappings/NREL_wind_ctry",
                      "energy/mappings/fuel_energy_input",  "energy/A20.wind_class_CFs", "L113.globaltech_capital_ATB",
                      "L113.globaltech_OMfixed_ATB", "energy/NREL_onshore_energy", "L223.StubTechCapFactor_elec") ->
      L2231.SmthRenewRsrcCurves_onshore_wind
