...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["ResTechCoef"]] <- c(level2_data_names[["SubRsrc"]], "technology", "year", "minicam.energy.input", "coefficient", "market.name")
  level2_data_names[["ResTechCoefAdj"]] <- c(level2_data_names[["SubRsrc"]], "technology", "year", "minicam.energy.input", "adj_coef_year", "current.coef")
  ...
  level2_data_names[["AbsCostLogitBaseValue"]] <- c("region", "supplysector", "base.value")
  ...
  level2_data_names[["TechInputPMult"]] <- c(level2_data_names[["TechYr"]], "minicam.energy.input", "price.unit.conversion")
  ...
  level2_data_names[["ResReserveTechCoefAdj"]] <- c("region", "resource", "reserve.subresource", "resource.reserve.technology", "year", "minicam.energy.input", "adj_coef_year", "current.coef")
  ...
  level2_data_names[["GlobalTechFractSecOut"]] <- c(level2_data_names[["GlobalTechYr"]], "fractional.secondary.output", "output.ratio")
  ...
  level2_data_names[["StubTechFixOut_otherBiod"]] <- c(level2_data_names[["StubTechYr"]], "fixedOutput", "share.weight.year", "share.weight")
  ...
  level2_data_names[["StubTechRESSecOut"]] <- c(level2_data_names[["StubTechYr"]], "res.secondary.output", "output.ratio")
  ...
  level2_data_names[["StubTranTechRES"]] <- c("region", "supplysector", "tranSubsector", "stub.technology", "year", "res.secondary.output", "output.ratio", "pMultiplier")
  ...
  level2_data_names[["StubTranTechInputNetSubsidy"]] <- c("region", "supplysector", "tranSubsector", "stub.technology", "year", "input.net.subsidy", "sector.name")
  ...
  level2_data_names[["LN1_SoilTimeScale_Peat"]] <- c("region", "LandAllocatorRoot", "LandNode1", "nodeSoilTimeScale")
