...
{
    /* Set the profit rate of unmanaged land leafs equal to the read in land price
...
/* Step 2. Set the profit rates to use at each node in the land allocation tree.  Note the choice
...
/* Step 3. Calculate share-weights with in each sub nest of the land allocation tree.  The scale
